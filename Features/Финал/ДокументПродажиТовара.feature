...
Сценарий: проверка заполнения документа расход товара
	...
	* Проведение
		...
		И пауза 5
	Сценарий: проверка проведения документа Расход Товара по Регистру взаиморасчетов с контрагентами	
		И В текущем окне я нажимаю кнопку командного интерфейса 'Регистр взаиморасчетов с контрагентами'
		И таблица "Список" содержит строки:
			| 'Период' | 'Регистратор' | 'Номер строки' | 'Контрагент'     | 'Сумма'  | 'Валюта' |
			| '*'      | '*'           | '1'            | 'ЭлектроБыт ЗАО' | '480,00' | 'Рубли'  |
	Сценарий: проверка проведения документа Расход Товара по Регистр продаж	
	...
	Сценарий: проверка проведения документа Расход Товара по Регистр товарных запасов
		И В текущем окне я нажимаю кнопку командного интерфейса 'Регистр товарных запасов'
		Тогда таблица "Список" содержит строки:
			| 'Период' | 'Склад'   | 'Регистратор' | 'Номер строки' | 'Товар' | 'Количество' |
			| '*'      | 'Большой' | '*'           | '1'            | 'Хлеб'  | '6,00'       |
		И В текущем окне я нажимаю кнопку командного интерфейса 'Основное'
	Сценарий: проверка проведения документа Расход Товара Печать Расходной Накладной	
